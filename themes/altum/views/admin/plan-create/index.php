            ...
            <div>
                ...
                <?php if(\Altum\Plugin::is_active('aix')): ?>
                    <div class="form-group">
                        ...
                        <select id="documents_model" name="documents_model" class="form-control">
                            <?php foreach(require \Altum\Plugin::get('aix')->path . 'includes/ai_text_models.php' as $key => $value): ?>
                                <option value="<?= $key ?>"><?= $value . ' - ' . $key . ' (' . l('global.plan_settings.documents_model.' . str_replace('-', '_', $key)) . ')' ?></option>
                            <?php endforeach ?>
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" id="images_per_month_limit" name="images_per_month_limit" min="-1" class="form-control" value="0" />
                        <small class="form-text text-muted"><?= l('admin_plans.plan.unlimited') ?></small>
                    </div>
                <?php endif ?>

...
<div class="my-5 row justify-content-between">
    ...
    <?php if(\Altum\Plugin::is_active('aix')): ?>
        ...
        <div class="col-12 col-sm-6 col-xl-3 mb-4 position-relative">
            <div class="card d-flex flex-row h-100 overflow-hidden">
                <div class="card-body">
                    <small class="text-muted"><i class="fa fa-fw fa-sm fa-icons mr-1"></i> <?= l('admin_user_view.icons') ?></small>

                    <div class="mt-3"><span class="h4"><?= nr($data->icons) ?></span></div>
                </div>

                <div class="pr-4 d-flex flex-column justify-content-center">
                    <a href="<?= url('admin/icons?user_id=' . $data->user->user_id) ?>" class="stretched-link">
                        <i class="fa fa-fw fa-angle-right text-gray-500"></i>
                    </a>
                </div>
            </div>

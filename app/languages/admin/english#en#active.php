...
return [
    ...
    'admin_plans.plan.documents_model_help' => 'Select the AI model the user has access to when generating AI documents. You can read more details about the models on <a href="https://platform.openai.com/docs/models/gpt-3" target="_blank">OpenAI Models</a> page.',

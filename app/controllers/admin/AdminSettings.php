...
class AdminSettings extends Controller {
    ...
    public function aix() {
        ...
        if(!empty($_POST)) {
            ...
            $_POST['input_moderation_is_enabled'] = (bool) $_POST['input_moderation_is_enabled'];
            $available_types = [];
            foreach($ai_types as $key => $value) {
                $available_types[$key] = in_array($key, $_POST['available_types'] ?? []);
            }
